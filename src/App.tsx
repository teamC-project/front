  ...
  return (
    <Routes >
      ...
      <Route path={AUTH_PATH} >
        ...
        <Route path={SIGN_UP_PATH} element={<ChooseSingUp />} />
        <Route path={CUSTOMER_SIGN_IN_URL} element={<CustomerSignUp />} />
        <Route path={DESIGNER_SIGN_IN_URL} element={<DesignerSignUp />} />
