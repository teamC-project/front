...
import { AUTH_PATH, CUSTOMER_BOARD_LIST_ABSOLUTE_PATH, CUSTOMER_BOARD_PATH, DESIGNER_BOARD_WRITE_ABSOLUTE_PATH, DESIGNER_BOARD_WRITE_PATH, MAIN_OFF_PATH, MAIN_ON_PATH, SERVICE_PATH, SIGN_IN_PATH, TREND_BOARD_LIST_ABSOLUTE_PATH, TREND_BOARD_PATH, TREND_BOARD_WRITE_ABSOLUTE_PATH, TREND_BOARD_WRITE_PATH } from "./constant";
