...
export default function TrendUpdate() {
	...
	const { trendBoardWriterId,
			trendBoardTitle, trendBoardContents 
...
useEffect(() => {
		if (!trendBoardNumber || !cookies.accessToken || !loginUserRole) return;
...
//										render										//
	return (
		<div id = 'trend-board-write-wrapper'>
			...
			<ToastEditor 
			ref={editorRef} body={trendBoardContents} setBody={onTrendBoardContentsChangeHandler} imageList={trendBoardUrlList} setImageList={onImageChangeHandler} />
      </div>
