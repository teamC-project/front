...
export const CUSTOMER_BOARD_COMMENT_WRITE_PATH = "commentWrite/:customerBoardNumber";
...
export const CUSTOMER_BOARD_ABSOLUTE_PATH = `${SERVER_API_URL}/${SERVER_CUSTOMER_BOARD_MODULE_URL}`;
export const CUSTOMER_BOARD_LIST_ABSOLUTE_PATH = `${SERVER_API_URL}/${CUSTOMER_BOARD_PATH}`;
export const CUSTOMER_BOARD_WRITE_ABSOLUTE_PATH = `${SERVER_API_URL}/${CUSTOMER_BOARD_PATH}/${CUSTOMER_BOARD_WRITE_PATH}`;
export const CUSTOMER_BOARD_DETAIL_ABSOLUTE_PATH =  (customerBoardNumber: number | string) => `${SERVER_API_URL}/${CUSTOMER_BOARD_PATH}/${customerBoardNumber}`;
export const CUSTOMER_BOARD_UPDATE_ABSOLUTE_PATH =  (customerBoardNumber: number | string) => `${SERVER_API_URL}/${CUSTOMER_BOARD_PATH}/update${customerBoardNumber}`;
export const CUSTOMER_BOARD_DELETE_ABSOLUTE_PATH =  (customerBoardNumber: number | string) => `${SERVER_API_URL}/${CUSTOMER_BOARD_PATH}/delete${customerBoardNumber}`;
export const CUSTOMER_BOARD_COMMENT_WIRTE_ABSOLUTE_PATH =  (customerBoardNumber: number | string) => `${SERVER_API_URL}/${CUSTOMER_BOARD_PATH}/comment${customerBoardNumber}`;
export const CUSTOMER_BOARD_COMMENT_UPDATE_ABSOLUTE_PATH =  (customerBoardNumber: number | string) => `${SERVER_API_URL}/${CUSTOMER_BOARD_PATH}/comment/update${customerBoardNumber}`;
export const CUSTOMER_BOARD_COMMENT_DELETE_ABSOLUTE_PATH =  (customerBoardNumber: number | string) => `${SERVER_API_URL}/${CUSTOMER_BOARD_PATH}/comment/delete${customerBoardNumber}`;
