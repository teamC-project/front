...
export const EMAIL_AUTH_REQUEST_PATH = `${AUTH_PATH}/email_auth`;
export const EMAIL_AUTH_CHECK_REQUEST_PATH = `${AUTH_PATH}/email_auth_check`;
export const SIGN_UP_REQUEST_PATH = `${AUTH_PATH}/sign_up`;
export const LOGOUT_REQUEST_PATH = `${AUTH_PATH}/logout`;
export const MY_PAGE_PATH = `${AUTH_PATH}/my_page`;
export const UPDATE_REQUEST_PATH = `${AUTH_PATH}/update`;
export const USER_DELETE_PATH = `${AUTH_PATH}/user_delete`;
...
export const QNA_BOARD_DETAIL_ABSOLUTE_PATH =(qnaBoardNumber : number | string) => 
	`${SERVICE_URL}/${TREND_BOARD_PATH}/${qnaBoardNumber}`;
