...
import { ADVERTISEMENT_PATH, MAILCONTECT_PATH, PERSONAL_INFO_PROCESSING_POLICY_PATH, SITE_DESCRIPTION_PATH, TEARMS_AND_CONDTIONS_PATH, YOUTH_PROTECTION_POLICY_PATH } from 'src/constant';
...
//                event handler               //
    ...
    return (
        ...
        <div className='footer-top-bar'>
            ...
            onClick={siteDescriptionClickHandler}
            >
            사이트소개
            </div>
            <div className=''>|</div>
            ...
            <div 
            className='cursor-pointer'
            onClick={personalInfoProcessingPolicyClickHander}
            >
            개인정보처리방침
            </div>
            <div className=''>|</div>
            <div
            className='cursor-pointer'
            onClick={youthProtectionPolicyClickHandler}
            >
            청소년보호정책
            </div>
            <div className=''>|</div>
            ...
            <div
            className='cursor-pointer'
            onClick={mailContectClickHandler}
            >
            메일문의
            </div>
        </div>
